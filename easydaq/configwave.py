...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.cBmode.addItem(_fromUtf8(""))
        self.cBmode.addItem(_fromUtf8(""))
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.cBmode)
        self.sWDC = QtWidgets.QStackedWidget(MainWindow)
        ...
        self.label_4 = QtWidgets.QLabel(self.page_21)
        ...
        self.label_2 = QtWidgets.QLabel(self.page_22)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.sWDC)
        self.sWDC2 = QtWidgets.QStackedWidget(MainWindow)
        self.sWDC2.setObjectName(_fromUtf8("sWDC2"))
        self.page_23 = QtWidgets.QWidget()
        self.page_23.setObjectName(_fromUtf8("page_23"))
        self.sBoffset = QtWidgets.QDoubleSpinBox(self.page_23)
        ...
        self.Bchoose = QtWidgets.QPushButton(self.page_24)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.sWDC2)
        self.sWamp1 = QtWidgets.QStackedWidget(MainWindow)
        ...
        self.lb_amplitude = QtWidgets.QLabel(self.page_17)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.sWamp1)
        self.sWamp2 = QtWidgets.QStackedWidget(MainWindow)
        self.sWamp2.setObjectName(_fromUtf8("sWamp2"))
        self.page_19 = QtWidgets.QWidget()
        self.page_19.setObjectName(_fromUtf8("page_19"))
        self.sBamplitude = QtWidgets.QDoubleSpinBox(self.page_19)
        ...
        self.lb_namefile = QtWidgets.QLabel(self.page_25)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.sWamp2)
        self.sWperiod1 = QtWidgets.QStackedWidget(MainWindow)
        ...
        self.lb_period = QtWidgets.QLabel(self.page_13)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.sWperiod1)
        self.sWperiod2 = QtWidgets.QStackedWidget(MainWindow)
        ...
        self.sBperiodms = QtWidgets.QDoubleSpinBox(self.page_15)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.sWperiod2)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.stackedWidget)
        ...
        self.sBtimeon = QtWidgets.QDoubleSpinBox(self.page_3)
        ...
        self.sBriseTime = QtWidgets.QDoubleSpinBox(self.page_4)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.stackedWidget_2)
        self.Bsubmit = QtWidgets.QPushButton(MainWindow)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.Bsubmit)
